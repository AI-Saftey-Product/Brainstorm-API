"""Base class for vision security tests."""
...
from brainstorm.testing.modalities.vision.optimizations import (
...
class BaseVisionSecurityTest(BaseTest):
    """Base class for all vision security tests."""
    
    def __init__(self, config: Dict[str, Any]):
        """Initialize the test with configuration."""
        super().__init__(config)
        self.test_type = "vision_security"  # Override base type
    ...
    async def generate_with_retry(self, prompt: str, image_path: str, max_retries: int = 3, **kwargs) -> str:
        """Generate text with retry logic for vision models."""
    ...
    def _evaluate_security_impact(
        ...
        """
        Evaluate the security impact of a vision-based attack.
