...
from .data_providers import DataProviderFactory, DataProvider
from .adversarial.base import AdversarialAttack
from .adversarial.prompt_injection_attacks import (
...
class PromptInjectionTest(BaseTest):
    ...
    def _register_models(self):
        """Register required models in the registry."""
        try:
            # Register models needed for attacks
            self.model_registry.register_model("use_encoder", {
                "backend": "tensorflow",
                "model_id": "universal-sentence-encoder"
            })
            self.model_registry.register_model("bert_score", {
                "backend": "transformers",
                "model_id": "bert-base-uncased"
            })
            self.model_registry.register_model("toxicity", {
                "backend": "detoxify",
